...
extern uint8_t g_uart_rx_queue[UART_CH1 + 1][UART_RX_BUFFER_SIZE]; /* receiving queue */
extern uint16_t g_uart_rx_queue_head[UART_CH1 + 1]; /* receiving queue head */
extern uint16_t g_uart_rx_queue_tail[UART_CH1 + 1]; /* receiving queue tail */
#endif
